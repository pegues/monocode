(function($) {
    ...
    $.fn.contextmenu = function(option) {
        ...
        //itemTpl = "<div class='b-m-$[type]' unselectable=on><nobr unselectable=on><span class='contextmenuicon' style='background: url(\"$[icon]\") 3px 50% no-repeat;' data-alias=\"$[alias]\" unselectable=on>$[text]</span></nobr></div>";
        itemTpl = "<div class='b-m-$[type]' unselectable=on><nobr unselectable=on><span class='contextmenuicon' style='' data-alias=\"$[alias]\" unselectable=on>$[text]</span></nobr></div>";
        ...
        function showMenu(e, menutarget) {
            target = menutarget;
            showMenuGroup.call(this, { left: e.pageX, top: e.pageY }, 0);

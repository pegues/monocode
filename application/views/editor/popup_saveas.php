...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function download() {
                ...
                parent.sceditor.call("base.file.saveToLocal()", {'name': fileName});
            }
            ...
            function __save() {
                ...
                parent.sceditor.call("base.file.saveAs()", {
                    'dir': directory,
                    'name': fileName,
                }, POPUP_ID);
            }
    ...
    <body data-width='600' data-height="310" data-controls="{'Cancel' : 'closeme','Save' : 'save'}" style="height: 100%;">
        <div class="infopopup" style="height: 100%;">
            <form id="saveas_form" class="" style="height: 100%;">

...
<head>
	...
	<script type="text/javascript">
		...
		function deleteFiles(e) {
			$.post('<?php echo base_url(); ?>file/delete/', e, function(data) {
				loadDir({'dir': e['1'].dir});
			})
		}
		...
		function create() {
			...
			parent.sceditor.call('base.template.create()', {
				'dir': directory,
			}, POPUP_ID);
		...
		function create_new_workspace() {
			...
			$.ajax({
				...
				if (status == true) {
                    ...
                    parent.sceditor.call("base.showMessages()", data.messages);
					return;
				}
...
<body data-width='600' data-height="310" data-controls="{'Cancel' : 'close','Create' : 'create'}" style="height: 100%;">

...
<head>
	...
	<script type="text/javascript">
		...
		function loadDir(e) {
			e.type = "dir";
			$.post('<?php echo base_url(); ?>file/dir2json', e, function(data) {
		...
		function move() {
			...
			parent.sceditor.call('base.file.moveTo()', {
				'dir': directory,
			}, POPUP_ID);
		}
...
<body data-width='600' data-height="310" data-controls="{'Cancel' : 'close','Move' : 'move'}" style="height: 100%;">
